...
4. Uses the available ETF assets provided above - prioritize these recommendations
...
7. Always uses real, available assets, DO NOT use other assets
...
4. Conservative portfolios: Include Gold (precious metals hedge) as 5-10% allocation (write only GOLD, do not use any other assets name)
